class UserTransaction {
  ...
  factory UserTransaction.fromResponse(Map<String, dynamic> response) {
    ...
    return UserTransaction(username: username, bookingHotels: bookingHotels, bookingFlights: bookingFlights);
  }
}
...
class TransactionHotels {
  ...
  factory TransactionHotels.fromJson(Map<String, dynamic> responseData) {
    ...
    return TransactionHotels(id: id, bookingDate: bookingDate, totalRoom: totalRoom, price: price, bookingHotelNo: bookingHotelNo);
  }
}
...
class TransactionFlights {
  ...
  factory TransactionFlights.fromJson(Map<String, dynamic> responseData) {
    ...
    return TransactionFlights(id: id, status: status, bookingDate: bookingDate, amountPassenger: amountPassenger, totalPrice: totalPrice, bookingFlightNo: bookingFlightNo);
  }
}