                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Icon(Icons.air_rounded, color: widget.hotel.facilitiesHotel.airConditioner == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.connected_tv_rounded, color: widget.hotel.facilitiesHotel.television == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.wifi, color: widget.hotel.facilitiesHotel.wifi == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.food_bank_rounded, color: widget.hotel.facilitiesHotel.restaurant == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.spa, color: widget.hotel.facilitiesHotel.spa == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.pool, color: widget.hotel.facilitiesHotel.pool == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.child_care_rounded, color: widget.hotel.facilitiesHotel.playground == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.sports_gymnastics, color: widget.hotel.facilitiesHotel.gym == true ? Color(0XFFE67E22) : Colors.grey),
                          Icon(Icons.local_parking_rounded, color: widget.hotel.facilitiesHotel.parking == true ? Color(0XFFE67E22) : Colors.grey),
                        ],
                      ),
                      const Text('ROOMS',
                          // ignore: prefer_const_constructors
