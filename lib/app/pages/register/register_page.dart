                  ...
                  Stack(alignment: Alignment.center, children: [
                    Column(
                      ...
                      children: [
                        ...
                        const Image(
                          image: AssetImage('assets/images/logo-lounga.png'),
                        ...
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.01),
                        TextFieldCustome(
                            textEditingController: controller.controllerFirstName,
                        ...
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.01),
                        TextFieldCustome(
                            textEditingController: controller.controllerLastName,
                            textLabel: 'Last Name'),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        const Text(
                        ...
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.01),
                        TextFieldCustome(
                            textEditingController: controller.controllerUsername,
                            textLabel: 'Username'),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        const Text(
                        ...
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.01),
                        TextFieldPassword(
                          textEditingController: controller.controllerPassword,
                          textLabel: 'Password',
                          visible: controller.visibilityPassword,
                          refresh: () => controller.showPassword(),
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        const Text(
                        ...
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.01),
                        TextFieldPassword(
                          textEditingController: controller.controllerConfirmPassword,
                          textLabel: 'Confirm Password',
                          visible: controller.visibilityConfirmPassword,
                          refresh: () => controller.showConfirmPassword(),
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        Center(
