...
class TransactionPage extends StatelessWidget {
  ...
  const TransactionPage(this.userTransaction, this.dropDownValueTransaction,
      this.refreshTransaction, this.isLoading,
      {super.key});
      ...
      children: [
        Container(
          ...
          child: DropdownButtonFormField(
              ...
              items: const [
                DropdownMenuItem(value: 1, child: Text("Hotel Transaction")),
                DropdownMenuItem(value: 2, child: Text("Flight Transaction"))
              ],
              onChanged: (int? value) {
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            DateFormat.yMMMEd().format(
                                                DateTime.parse(userTransaction
                                                    .bookingHotels[index]
                                                    .bookingDate)),
                                            style: const TextStyle(
                                                fontWeight: FontWeight.bold),
