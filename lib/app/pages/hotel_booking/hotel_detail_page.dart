...
class HotelDetailPage extends View {
  ...
  State<StatefulWidget> createState() {
    final hotelDetailController = Injector.appInstance.get<HotelDetailController>();
    return _HotelDetailViewState(hotelDetailController);
  }
}

class _HotelDetailViewState extends ViewState<HotelDetailPage, HotelDetailController> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 7),
                  Text(widget.hotel.facilitiesHotel.airConditioner.toString()),
                  const Text('ROOMS',
                    // ignore: prefer_const_constructors
                    style: TextStyle(
                      fontSize: 15,
                    ...
                    child: GestureDetector(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Text('Rp ${widget.hotel.roomsHotel.first.price}/room/night', textAlign: TextAlign.right,))
                      ],
                    )    
                    )    
                  ),
